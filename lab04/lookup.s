...
main:
   ...
   # move  $a0, $t0              # printf("%d"); testing
   # li    $v0, 1
   # syscall

   # move  $a0, $t1              # printf("%d"); testing
   # li    $v0, 1
   # syscall

    # PUT YOUR CODE HERE
    # End of scanning in numbers, start of my CODE
    li $t5, 0           #$t5 = x
    li $t6, 0
row_loop: 
    beq $t5, $t0, col_loop   #$t5 < t0 -> end 
    li $t6, 0           #$t6 = y (col loop counter)

   # move  $a0, $t5              # printf("%d"); testing
   # li    $v0, 1
   # syscall
...
col_loop: 
    beq $t6, $t1, col_loop_end

    #move  $a0, $t6              # printf("%d"); testing
    #li    $v0, 1
   # syscall
...
col_loop_end: 
    ...
    la   $t0, array             # printf("%d", numbers[i][j]);
    ...
    lw   $a0, 0($t4)            #printf("%d", numbers[x][y]);
    li   $v0, 1
    syscall

    #li $a0,  42                # printf("%d", 42)  change this to print {{}}
   # li $v0, 1
    #syscall
